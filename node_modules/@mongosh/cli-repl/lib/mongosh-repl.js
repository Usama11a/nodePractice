...
class MongoshNodeRepl {
    ...
    async initialize(serviceProvider) {
        ...
        const shellEvaluator = new shell_evaluator_1.ShellEvaluator(internalState);
        ...
        try {
            ...
            repl.on('flushHistory', function () {
                ...
                history_1.changeHistory(history, redactInfo);
            });
...
function isErrorLike(value) {
    try {
        return value && ((value.message !== undefined && typeof value.stack === 'string') ||
