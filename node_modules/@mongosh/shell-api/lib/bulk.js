...
let BulkFindOp = class BulkFindOp extends decorators_1.ShellApiWithMongoClass {
    ...
    arrayFilters() {
        throw new errors_1.MongoshUnimplementedError('arrayFilters method on fluent Bulk API is not currently supported.', errors_1.CommonErrors.NotImplemented, error_codes_1.blockedByDriverMetadata('BulkFindOp.arrayFilters'));
    }
    hint(hintDoc) {
