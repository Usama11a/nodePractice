...
export default class Collection extends ShellApiWithMongoClass {
    ...
    findOne(query?: Document, projection?: Document): Promise<Document | null>;
    ...
    validate(full?: boolean): Promise<Document>;
