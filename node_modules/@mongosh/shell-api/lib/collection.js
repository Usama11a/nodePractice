...
let Collection = class Collection extends decorators_1.ShellApiWithMongoClass {
    ...
    async getShardDistribution() {
        ...
        await Promise.all(conciseShardsStats.map((shardStats) => ((async () => {
    ...
    watch(pipeline = [], options = {}) {
        ...
        const cursor = new change_stream_cursor_1.default(this._mongo._serviceProvider.watch(pipeline, options, {}, this._database._name, this._name), this._name, this._mongo);
        this._mongo._internalState.currentCursor = cursor;
        return cursor;
    }
