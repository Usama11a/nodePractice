...
let Database = class Database extends decorators_1.ShellApiWithMongoClass {
    ...
    getCollection(coll) {
        ...
        if (!coll.trim()) {
            throw new errors_1.MongoshInvalidInputError('Collection name cannot be empty.', errors_1.CommonErrors.InvalidArgument);
        }
    ...
    watch(pipeline = [], options = {}) {
        ...
        const cursor = new change_stream_cursor_1.default(this._mongo._serviceProvider.watch(pipeline, options, {}, this._name), this._name, this._mongo);
        this._mongo._internalState.currentCursor = cursor;
        return cursor;
    }
};
