...
export declare function shellApiClassGeneric(constructor: Function, hasHelp: boolean): void;
...
export declare function returnType(type: string | TypeSignature): Function;
export declare function classReturnsPromise(constructor: Function): void;
