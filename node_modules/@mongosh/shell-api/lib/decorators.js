...
exports.addSourceToResults = exports.classPlatforms = exports.platforms = exports.classDeprecated = exports.classReturnsPromise = exports.returnType = exports.shellCommandCompleter = exports.directShellCommand = exports.returnsPromise = exports.nonAsyncFunctionsReturningPromises = exports.topologies = exports.deprecated = exports.serverVersions = exports.signatures = exports.shellApiClassNoHelp = exports.shellApiClassDefault = exports.shellApiClassGeneric = exports.toIgnore = exports.toShellResult = exports.getShellApiType = exports.ShellApiValueClass = exports.ShellApiWithMongoClass = exports.ShellApiClass = void 0;
...
function wrapWithApiChecks(fn, className) {
    const wrapper = fn.returnsPromise ?
        markImplicitlyAwaited(async function (...args) {
            ...
            const interrupted = interruptor_1.checkInterrupted(internalState);
            let result;
            try {
                ...
                throw mongo_errors_1.rephraseMongoError(e);
            }
...
exports.toIgnore = ['constructor', 'help'];
...
exports.shellApiClassGeneric = shellApiClassGeneric;
...
function classReturnsPromise(constructor) {
    constructor.prototype.returnsPromise = true;
}
exports.classReturnsPromise = classReturnsPromise;
