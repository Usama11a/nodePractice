...
let ClientEncryption = class ClientEncryption extends decorators_1.ShellApiWithMongoClass {
    ...
    [enums_1.asPrintable]() {
        return `ClientEncryption class for ${history_1.redactCredentials(this._mongo._uri)}`;
    }
...
let KeyVault = class KeyVault extends decorators_1.ShellApiWithMongoClass {
    ...
    [enums_1.asPrintable]() {
        return `KeyVault class for ${history_1.redactCredentials(this._mongo._uri)}`;
    }
    async createKey(kms, masterKeyOrAltNames, keyAltNames) {
        ...
        const keyId = await this._clientEncryption._libmongocrypt.createDataKey(kms, options);
        if (((_a = options === null || options === void 0 ? void 0 : options.keyAltNames) === null || _a === void 0 ? void 0 : _a.length) && !((_c = (_b = (await this.getKey(keyId).next())) === null || _b === void 0 ? void 0 : _b.keyAltNames) === null || _c === void 0 ? void 0 : _c.length)) {
