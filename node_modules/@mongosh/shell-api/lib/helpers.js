...
function validateExplainableVerbosity(verbosity) {
    ...
    if (!allowedVerbosity.includes(verbosity)) {
        throw new errors_1.MongoshInvalidInputError(`verbosity can only be one of ${allowedVerbosity.join(', ')}. Received ${verbosity}.`, errors_1.CommonErrors.InvalidArgument);
    }
    return verbosity;
}
