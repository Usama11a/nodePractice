...
let Mongo = class Mongo extends decorators_1.ShellApiClass {
    ...
    async _batchSize() {
        var _a;
        return (_a = this._internalState.batchSizeFromDBQuery) !== null && _a !== void 0 ? _a : await this._internalState.shellApi.config.get('batchSize');
    }
    [enums_1.asPrintable]() {
        return history_1.redactCredentials(this._uri);
    }
    ...
    _getDb(name) {
        ...
        if (!name.trim()) {
            throw new errors_1.MongoshInvalidInputError('Database name cannot be empty.', errors_1.CommonErrors.InvalidArgument);
        }
    ...
    watch(pipeline = [], options = {}) {
        ...
        const cursor = new change_stream_cursor_1.default(this._serviceProvider.watch(pipeline, options), history_1.redactCredentials(this._uri), this);
...
Mongo = __decorate([
    ...
    decorators_1.classReturnsPromise,
