...
function constructShellBson(bson, printWarning) {
    ...
    const bsonPkg = {
        DBRef: Object.assign(function (namespace, oid, db) {
            helpers_1.assertArgsDefinedType([namespace, oid, db], ['string', true, [undefined, 'string']], 'DBRef');
            return new bson.DBRef(namespace, oid, db);
        }, { prototype: bson.DBRef.prototype }),
        Map: bson.Map,
        bsonsize: function (object) {
            helpers_1.assertArgsDefinedType([object], ['object'], 'bsonsize');
            return bson.calculateObjectSize(object);
        },
        MaxKey: Object.assign(function () {
            return new bson.MaxKey();
        }, { prototype: bson.MaxKey.prototype }),
        MinKey: Object.assign(function () {
            return new bson.MinKey();
        }, { prototype: bson.MinKey.prototype }),
        ObjectId: Object.assign(function (id) {
            helpers_1.assertArgsDefinedType([id], [[undefined, 'string']], 'ObjectId');
            return new bson.ObjectId(id);
        }, { prototype: bson.ObjectId.prototype }),
        Timestamp: Object.assign(function (low = 0, high = 0) {
            helpers_1.assertArgsDefinedType([low, high], ['number', 'number'], 'Timestamp');
            return new bson.Timestamp(low, high);
        }, { prototype: bson.Timestamp.prototype }),
        Code: Object.assign(function (c = '', s) {
            helpers_1.assertArgsDefinedType([c, s], [[undefined, 'string'], [undefined, 'object']], 'Code');
